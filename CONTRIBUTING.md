...
3. Make the fix or add features. The main code is located in [main.cpp](https://github.com/nadchif/phone-resolution-tool/blob/master/main.cpp)

4. Run tests to make sure there are no errors
